...
// read_locations is only actually needed for the self-connect install onto
// la-diesse.myshopify.com itself (lib/brandProductImport.js looks up a
// destination location there) — brands never need it for the pull, but
// Shopify apps request one fixed scope set across every store they're
// installed on, so brands see this scope too even though it's unused on
// their side.
