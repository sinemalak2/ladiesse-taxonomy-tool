...
function normalizeText(s) {
  return s
    .toLowerCase()
    .normalize('NFKD')
    .replace(/[̀-ͯ]/g, ''); // strip any accented characters values might contain
}

// tag_categories.values entries can carry a parenthetical qualifier (a
// translation, an aside, etc.) — match against the primary (pre-paren) term.
