...
// products instead of trying to update ones that no longer exist. Used both
// by the standalone "Delete products" admin action and by the brand DELETE
// route (app/api/brands/[id]/route.js), which needs this run first —
// otherwise those draft products would be orphaned on la-diesse with no
// remaining record of which brand they came from.
