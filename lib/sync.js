...
const UPSERT_PRODUCT_SQL = `
  INSERT INTO products (id, title, handle, image_url, price, status, description, raw_shopify_data, synced_at)
...
export async function syncShopifyProducts() {
  ...
  try {
    ...
    while (hasNextPage) {
      // Archived products are excluded here rather than deleted on sync —
      // see scripts/prune-removed-products.js for one-off cleanup.
